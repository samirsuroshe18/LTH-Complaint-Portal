...
import { approveResolution, assignedTechnician, createSectorAdmin, deactivateSectorAdmin, getAllSectorAdmin, getComplaintDetails, getComplaints, getDashboardOverview, getSelectionTechnician, rejectResolution, removeSectorAdmin, reopenComplaint } from "../controllers/admin.controller.js";
...
router.route('/get-selection-technician/:technicianType').get(verifyJwt, verifyAdmin, getSelectionTechnician);
