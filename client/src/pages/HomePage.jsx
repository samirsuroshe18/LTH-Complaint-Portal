  ...
  return (
    <div className={`min-h-screen ${themeClasses.background} py-8 px-4`}>
      <div className="max-w-6xl mx-auto">
          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <h3
                  className={`${themeClasses.textPrimary} font-semibold text-center leading-tight`}
                >
                  {category.title}
                </h3>
              </button>
        ...
        {/* Note */}
        <aside
          className={`${themeClasses.cardBackground} ${themeClasses.border} ${themeClasses.borderLight} p-4 rounded-r-lg`}
        >
